...
export function useCreateJob() {
  ...
  return useMutation({
    mutationFn: async (job: { property_id: string; cleaner_id: string; date: string; start_time?: string; client_price?: number; cleaner_payout?: number; km_driven?: number; notes?: string }) => {
